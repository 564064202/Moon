...
namespace CodeRobot
{
	public partial class frmMain :  Form
	{
		...
		private void cbHistoryProject_SelectedIndexChanged(object sender, EventArgs e)
		{
			...
			else
			{
                ...
                txtFilePath.Text = dbConfig.Path;
			}
		}
		...
		private void btnLogin_Click(object sender, EventArgs e)
		{
			...
			try
			{
				if (TestConnection())
				{
					SaveDbConfiger(txtFilePath.Text);
		...
		private void SaveDbConfiger(string path)
		{
			UpdateOrCreateConnectionString(path,txtProjectName.Text, txtConStr.Text, GetDbProvider(cbDbType.SelectedItem.ToString()));
		}
		...
		public bool UpdateOrCreateConnectionString(string path,string name, string connectionString, string providerName)
		{
		...
		private bool DeleteConfig(string configName)
		{
			...
			try
			{
				...
				if (element != null)
				{
                    ...
                    Util.DeleteProjectPath(configName);
					isSuccess = true;
				}
			}
			catch
        ...
        private void stslblUS_Click(object sender, EventArgs e)
        {
            string url = "http://www.cnblogs.com/humble";
            FrmWb frm = new FrmWb("众人交流", url);
            frm.Show();
        }
	}
	...
	public class CustomerDbConfig
	{
        ...
        public string Path
        {
            get
            {
                return Util.GetProjectPath(this.ProjectName);
            }
            set
            {
                 Util.SetProjectPath(this.ProjectName,value);
            }
        }
	}
